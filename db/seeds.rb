...
protected_classes = hate_crimes.categories.create(title: "Protected Classes", description: category_desc)
  protected_classes.subcategories.create(title: "Sexual Orientation", description: subcategory_desc, score: 5)
  protected_classes.subcategories.create(title: "Gender Identity", description: subcategory_desc, score: 5)
  protected_classes.subcategories.create(title: "Religion", description: subcategory_desc, score: 5)
  protected_classes.subcategories.create(title: "National Origin", description: subcategory_desc, score: 5)
documentation = hate_crimes.categories.create(title: "Documentation", description: category_desc)
  documentation.subcategories.create(title: "Reporting", description: subcategory_desc, score: 4)
  documentation.subcategories.create(title: "Collection", description: subcategory_desc, score: 4)
prosecution_harass = hate_crimes.categories.create(title: "Prosecution of Harassment", description: category_desc)
  prosecution_harass.subcategories.create(title: "General", description: subcategory_desc, score: 5)
prosecution_crime = hate_crimes.categories.create(title: "Prosecution of Crime", description: category_desc)
  prosecution_crime.subcategories.create(title: "General", description: subcategory_desc, score: 5)
victim_support = hate_crimes.categories.create(title: "Victim Support", description: category_desc)
  victim_support.subcategories.create(title: "LGBTQ", description: subcategory_desc, score: 5)
  victim_support.subcategories.create(title: "Muslim", description: subcategory_desc, score: 3)
  victim_support.subcategories.create(title: "Jewish", description: subcategory_desc, score: 3)
  victim_support.subcategories.create(title: "Religious - Other", description: subcategory_desc, score: 3)
  victim_support.subcategories.create(title: "Immigrants", description: subcategory_desc, score: 3)
  victim_support.subcategories.create(title: "Race", description: subcategory_desc, score: 2)
key_allies = hate_crimes.categories.create(title: "Key Allies", description: category_desc)
  key_allies.subcategories.create(title: "Attorney General", description: subcategory_desc, score: 5)
  key_allies.subcategories.create(title: "Local Prosecutors", description: subcategory_desc, score: 4)
anti_bias_curriculum = hate_crimes.categories.create(title: "Anti-Bias Curriculum in Schools", description: category_desc)
  anti_bias_curriculum.subcategories.create(title: "General", description: subcategory_desc, score: 3)
ngos = hate_crimes.categories.create(title: "Non-Governmental Leadership", description: category_desc)
  ngos.subcategories.create(title: "Anti-Defamation League", description: subcategory_desc, score: 5)
  ngos.subcategories.create(title: "LGBTQ Advocacy", description: subcategory_desc, score: 5)
  ngos.subcategories.create(title: "Immigrant Advocacy Organizations", description: subcategory_desc, score: 4)
